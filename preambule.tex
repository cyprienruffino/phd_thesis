...
%% Réglage des fontes, des typo  et des graphiques
...
\usepackage{amsthm}				 % Permet d'utiliser des environnements proof, theorem, lemma et property
...
\usepackage{hyperref}	% Créera automatiquement les liens internes au PDF
...
\usepackage[top=3.5cm, bottom=3cm, left=3cm, right=2.5cm,
