...
% Pour le glossaire
\newcommand{\gl}[2]{\hyperref[gl:#1]{{\color{\cole}#2\footnote{Glossary \ref{gl:#1}}}}}  % Pour référencer une entrée de glossaire

\newcommand{\glnf}[2]{\hyperref[gl:#1]{{\color{\cole}#2\footnote{Glossary \ref{gl:#1}}}}}  % Pour référencer une entrée de glossaire
