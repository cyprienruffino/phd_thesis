...
% Pour le glossaire
\newcommand{\gl}[2]{\hyperref[gl:#1]{{\color{\cole}#2\footnote{see Glossary, Appendix \ref{gl:#1}}}}}  % Pour référencer une entrée de glossaire

\newcommand{\glnf}[2]{\hyperref[gl:#1]{{\color{\cole}#2\footnotemark}}}  % Pour référencer une entrée de glossaire
