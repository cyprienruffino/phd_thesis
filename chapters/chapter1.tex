...
Although we restrict ourselves to image generation, it is worth noting that the application range of \ac{GAN}s covers text generation \citep{???}, videos or sound
