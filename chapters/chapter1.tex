...
\begin{figure}
	...
	\caption[Generative modeling]{Left: Discriminative modeling, the model aims assign a class to each data point. Right: Generative modeling, the model aims to learn the probability distribution of the data.}
	\label{fig:disc_gen}
\end{figure}
