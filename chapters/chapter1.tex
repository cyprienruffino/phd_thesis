...
Although we restrict ourselves to image generation, it is worth noting that the application range of \ac{GAN}s covers text \citep{Guo2018}, video \citep{Clark2020} or sound generation. These application domains are beyond the scope of the thesis.
