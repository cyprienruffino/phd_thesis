...
Finally, another interesting perspective would be to apply this domain-transfer approaches to different domains. Indeed, polarimetric data are widely used in, for example, medical imaging \citep{Novikova2018, Rehbinder2016} and Synthetic-Aperture Radar \citep{vanZyl2011} imaging for topological data.