...
As opposed to the methods studied in Chapter \ref{chap:chapter2}, our CycleGAN-based approach is not stochastic. This implies that it is not possible to generate different polarimetric images for a given color sample.
