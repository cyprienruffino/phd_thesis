...
\subsubsection*{UNet} \label{gl:unet} A UNet  \citep{Ronneberger2015} is an \gl{encdec}{Encoder-Decoder} architecture with skip-connections between layers of the encoder and the decoder.