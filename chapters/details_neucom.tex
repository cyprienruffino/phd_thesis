...
Additional information: \begin{itemize}
	...
	\item \gl{instnorm}{Instance normalization} \citep{Ulyanov2016} is applied across all the layers. This is involved by the use of the PacGAN technique.
	\item The layers noted with an asterisk are linked with a \glnf{skip}{skip-connection}
\end{itemize}
&
