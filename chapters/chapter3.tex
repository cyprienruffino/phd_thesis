...
Another future work  direction would  be to improve the quality of the small objects in generated images, in order to enhance the performances of the road-scene analysis models on, for example, pedestrian detection. By using better architectures and introducing more recent techniques (see Section \ref{sec:improvements})
