...
\begin{chapterabstract}
	...
	We end the chapter by proposing some perspectives on training CycleGANs for generating polarimetric images using proximal methods. We formulate a projection operator and propose two algorithms that could potentially allow for generating realistic polarimetric images.
\end{chapterabstract}\\
