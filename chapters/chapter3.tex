...
In this section, we introduce new approaches for transferring color images to the polarimetric domain. W formulate an operator for projecting generated images onto the space delimited by the constraints, 
