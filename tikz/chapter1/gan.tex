...
%	\filldraw[fill=\cold, draw=black] plot coordinates {(.4,0) (.4,2.5) (1.2,2.5) (1.2,0) (.4,0) };
	...
	\draw node at (.8,1.2) {\Large$\tilde{\setX}$};
	
	\draw[-, line width=.2mm] (1.2,1.2)--(2.1,1.2);
	\draw[-, line width=.2mm] (2.1,1.2)--(2.1,0);
	\draw[->, line width=.2mm] ((2.1,0)--(3,0);
	
	\draw[-, line width=.2mm] (1.2,-1.7)--(2.1,-1.7);
	\draw[-, line width=.2mm] (2.1,-1.7)--(2.1,-0.5);
	\draw[->, line width=.2mm] ((2.1,-0.5)--(3,-0.5);
		
	\tikznn{3}{-1.5}{draw=black,fill=\colb}
	\draw node at (4.2,-0.3) {\Large$D$};

	\filldraw[fill=\cold,draw=black] plot coordinates {(5.7,-1) (5.7,0.5) (6.2,0.5) (6.2,-1) (5.7,-1) };
	
	\draw node at (5.95,-0.7) {\large$0$};
	\draw node at (5.95,0.1) {\large$1$};
