...
\begin{document}
	...
	\filldraw[fill=\cold, draw=black] plot coordinates {(1,0) (1,2.5) (1.8,2.5) (1.8,0) };
	\draw node at (1.4,1.2) {\Large$\setX$};
		
	\tikznn{2}{0}{draw=black,fill=\cola}
	\draw node at (3,1.2) {\Large$F$};

	\filldraw[fill=\colc,draw=black] plot coordinates {(4.7,0.5) (4.7,2) (5.2,2) (5.2,0.5) (4.7,0.5) };
	...
	\filldraw[fill=\colc,draw=black] plot coordinates {(7.8,0.5) (7.8,2) (8.3,2) (8.3,0.5) (7.8,0.5)};	
	\draw node at (8,1.2) {\Large$\vz$};
	...
	\filldraw[fill=\cold,draw=black]  plot coordinates {(4.75,-.25) (5.25,-0.25) (5.25,0.25) (4.75,0.25) (4.75,-.25)} ;
	...
	\begin{scope}[xshift=15cm,yshift=2.5cm,rotate=180]
		\tikznn{4}{0}{fill=\colb}
	\end{scope}
	\draw node at (10,1.2) {\Large$G$};
	
	\filldraw[fill=\cold, draw=black] plot coordinates {(11.2,0) (11.22,2.5) (12,2.5) (12,0) };
	\draw node at (11.6,1.2) {\Large$\hat{\setX}$};
