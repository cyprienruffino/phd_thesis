...
\begin{document}
	...
	\draw node at (-3.1,1.2) {\Large$\setY$};
	...
	%Yhat
		...
		\draw node at (3.2,1.2) {\Large$\Hat{\setY}$};
	
	%Y
	\tikzbrectshort{2.8}{-2.7}{fill=\colc,draw=black}
	\draw node at (3.2,-1.8) {\Large$\setY$};
	...
	\draw node at (7.9,1.2) {\Large$\tilde{\setX}$};
	...
	\draw node at (10.3,1.2) {\Large$\tilde{\setY}$};
