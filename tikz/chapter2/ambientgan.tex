...
\begin{document}
	...
	\tikzbrectshort{2.8}{-2.3}{fill=\colc,draw=black}
	\draw node at (3.2,-1.4) {\Large$\vy$};
	
	
	\draw[-, line width=.2mm] (3.6,1.2)--(4,1.2);
	\draw[-, line width=.2mm] (4,1.2)--(4,0.2);
	\draw[->, line width=.2mm] (4,0.2)--(4.6,0.2);
	
	\draw[-, line width=.2mm] (3.6,-1.3)--(4,-1.3);
	\draw[-, line width=.2mm] (4,-1.3)--(4,-0.3);
	\draw[->, line width=.2mm] ((4,-0.3)--(4.6,-0.3);
		
	\tikznn{4.6}{-1.3}{draw=black,fill=\cola}
	\draw node at (5.8,-0.1) {\Large$D$};

	%\filldraw[fill=\cold,draw=black] plot coordinates {(5.7,-1) (5.7,0.5) (6.2,0.5) (6.2,-1) (5.7,-1) };
	\tikzbrectsmall{7.3}{-0.8}{fill=\colb,draw=black}
		
	\draw node at (7.55,-0.5) {\large$0$};
	\draw node at (7.55,0.3) {\large$1$};
